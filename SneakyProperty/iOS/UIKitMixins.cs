...
{
	public static class UIKitMixins
	{
		public static void TerminatorDispose(this UIView view) 
		{
			...
			try {
				...
				if (enableLogging) {
					viewDescription = view.GetType().ToString();// view.Description;
				...
				if (view is UIActivityIndicatorView) {
					...
					scrollView.ViewForZoomingInScrollView = sv => null;
				}
		...
		public static void RemoveAndDisposeChildSubViews(this UIView view) {
			...
			if (view.Subviews == null)
				return;
			foreach (var currentView in view.Subviews){
				currentView.RemoveFromSuperviewAndDispose();
			}
		}
		...
		public interface IIgnoreDispose {}
	}
}
